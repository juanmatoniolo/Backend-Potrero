...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="navbar">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li>
                    <a class="dropdown-item" href="./pestanias/sinalcohol.php"
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li>
                    <a class="dropdown-item" href="./pestanias/hamburguesa.php"
                  ...
                  <li>
                    <a class="dropdown-item" href="./pestanias/rebozados.ph"
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li>
                    <a class="dropdown-item" href="./php/listar.php"
                      ><strong>LISTAR</strong></a
                    >
                  </li>
                </ul>
              </li>
     ...
     <table style="text-align: center" border="3px" class="table">
        ...
        $consulta = "SELECT*FROM nav WHERE id > 9 ";
