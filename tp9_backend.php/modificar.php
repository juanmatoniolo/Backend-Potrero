...
$consulta = "SELECT * FROM tiendapotrero WHERE id=$id";
...
<html lang="en">
    ...
    <body>
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="ropa" placeholder="ropa" value="<?php echo "$tipo_prenda"; ?>"> 
            <label>Marca</label>
        ...
        if(array_key_exists('guardar_cambios',$_POST)){
            ...
            // a) generar la consulta a realizar
             $consulta = "UPDATE tiendapotrero SET ropa='$tipo_prenda', marca='$marca', talle='$talle', precio='$precio', imagen='$imagen' WHERE id =$id";
